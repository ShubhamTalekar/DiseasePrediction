...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Prediction using Machine Learning", fg="black", bg="white")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by SHUBHAM TALEKAR", fg="white", bg="black")
w2.config(font=("Aharoni", 9))
w2.grid(row=2, column=0, columnspan=4, padx=100)

# labels
NameLb = Label(root, text="Name of the Patient:", fg="black", bg="white")
NameLb.config(font=("Times New Roman", 12))
